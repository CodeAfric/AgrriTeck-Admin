...
class Diseases {
  ...
  List images;
  List causes,signs,treatment,preventiveM;
  Diseases({this.diseaseId,this.name, this.description, this.images, this.causes, this.signs, this.treatment, this.preventiveM});
  ...
  Diseases.fromMapObject(Map<String, dynamic> map) {
    this.diseaseId = map['_id'];
    this.name = map['name'];
    this.description = map['phone'];
    this.images = map['size'];
...
class Community {
   String userImage,name,location,date,question,occupation,description,postId,relatedCrop;
   List images;
  Community({this.userImage,this.images, this.name, this.location, this.date, this.question,
      this.description,this  .occupation,this.postId,this.relatedCrop});
  Map<String, dynamic> toMap() {
    var map = Map<String, dynamic>();
...
class Market{
  String productName,measure,productId,timeStamp;
  int quantity;
  double price;
  ...
  Market(this.productName, this.measure, this.productId, this.timeStamp,
      this.quantity, this.price, this.farmer, this.images);
